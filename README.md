...
│   ├── general-api.js       z.ai General API Endpoint (glm-4.7-flash)
...
| Free | General API Endpoint (z.ai) | glm-4.7-flash | Free |
...
### General API Endpoint (z.ai)
1. Get API key for `https://api.z.ai/api/paas/v4/`.
2. Select the Free tier and use model `glm-4.7-flash`.
3. Keep Base URL as `https://api.z.ai/api/paas/v4`.
4. For Coding-only scenarios, use `https://api.z.ai/api/coding/paas/v4` (not for general chat).
