...
const CONNECTION_TEST_TIMEOUT_MS = 17000;
    ...
    case 'testConnection': {
      ...
      try {
        await runWithTimeout(
          dispatchConnection(conn, buildResultPayload({ success: true, steps: 0, summary: 'Test' }, { source: 'test' }), true),
          CONNECTION_TEST_TIMEOUT_MS,
          `Connection test (${conn.id})`,
        );
