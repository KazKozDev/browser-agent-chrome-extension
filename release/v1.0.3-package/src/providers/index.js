...
export class ProviderManager {
  ...
  _sanitizeConfig() {
    ...
    // Migrate users who had siliconflow or groq configured.
    if (this.config.primary === 'siliconflow' || this.config.primary === 'groq') {
      this.config.primary = 'ollama';
    }
  ...
  static getProviderInfo() {
    return {
      ...
      fireworks: {
        ...
        pricing: 'See Fireworks pricing',
        costPerMTokenIn: 0.60,
        costPerMTokenOut: 3.00,
        vision: true,
        tools: true,
        signupUrl: 'https://fireworks.ai/',
        note: 'Model: accounts/fireworks/models/kimi-k2p5. API base: https://api.fireworks.ai/inference/v1.',
        tier: 'recommended',
      },
      ollama: {
        label: 'Ollama',
